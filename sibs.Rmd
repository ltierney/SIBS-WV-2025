...
<!-- Shannon County was renamed to Oglala Lakota County in June 2015.
New FIPS is 46102 -->
...
group_by(lausUS, Period) %>% summarize(rate = 100 * (sum(Unemployed, na.rm = TRUE) / sum(LaborForce, na.rm = TRUE))) %>%  ggplot(aes(Period, rate, group = 1)) + geom_line()
```
