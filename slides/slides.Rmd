...
<https://github.com/ltierney/SIBS-WV-2022.git>.
...
* You can use the `git` command line client with
    ```shell
git clone https://github.com/ltierney/SIBS-WV-2022.git
    ```

--

Materials are also available at
<https://www.stat.uiowa.edu/~luke/SIBS-R/SIBS-WV-2022/>.
...
<http://www.stat.uiowa.edu/~luke/classes/STAT4580-2022/>
