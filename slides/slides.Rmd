...
<https://github.com/ltierney/SIBS-WV-2023.git>.
...
* You can use the `git` command line client with
    ```shell
git clone https://github.com/ltierney/SIBS-WV-2023.git
    ```

--

Materials are also available at
<https://www.stat.uiowa.edu/~luke/SIBS-R/SIBS-WV-2023/>.
...
<http://www.stat.uiowa.edu/~luke/classes/STAT4580-2023/>
...
> ([Second edition in progress.](http://r4ds.hadley.nz/))
...
{{content}}
--
In R 4.1.0 and later versions you can also use the base R pipe operator `|>`.
</div>
<!-- foobar - don't ask -->
