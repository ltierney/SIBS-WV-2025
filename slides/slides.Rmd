...
An alternative approach uses the _pipe operator_:
...
file](../data/Invasive-Cancer-Incidence-Rates-by-County-in-Iowa-Lung-and-Bronchus-2011.csv)
in the project.
